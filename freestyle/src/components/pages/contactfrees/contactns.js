...
class Contactns extends Component{
    ...
    componentDidMount(){
      ...
      butonforsendcustomer(e){
        ...
        axios.post("http://5.23.48.203:1338/api/sendmail",{number:this.state.phonenumbercustomer,name:this.state.namecustomer})
        .then(response=>{
        ...
        return(
                ...
                <section className="difffh2h2h21xacr">
                    ...
                    <div className="difffh2h2h21xacr12">
                        <div className="difffh2h2h21xacr12s">
                          ...
                          <p className="text_02_for_cont">{this.state.content.article3}
            ...
            <section className="nash_ofic_lichshe1">
              ...
              <div className="nash_ofic_lichshe1div">
                  <div><p><a href = "tel:+77272941415">Тел. +7 (727)-294-14-15</a></p></div>
