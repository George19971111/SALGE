...
class Constructor extends Component {
  ...
  async componentDidMount() {
    ...
    if (params.postID == "new") {
      ...
      axios
        .post("http://5.23.48.203:1338/api/post", { id: params.postID })
        .then(response => {
          ...
          img.src = "http://5.23.48.203:1338/" +response.data[0].main_foto;
  ...
  onclickbuttontest(e) {
    ...
    axios({
      url: "http://5.23.48.203:1338/api/upload",
      method: "POST",
      data: formdata
    }).then(response => {
      if(response.data.path){
        let imagges = document.createElement("img");
      imagges.src = "http://5.23.48.203:1338/" + response.data.path;
  ...
  if(this.state.title== ''){
    ...
    if (this.state.changee) {
      ...
      axios
        .post("http://5.23.48.203:1338/api/update", jsonPost)
        .then(response => {
      ...
      axios
        .post("http://5.23.48.203:1338/api/addpost", jsonPost)
        .then(response => {
          console.log(response);
          if (
            // eslint-disable-next-line
  ...
  linksendtomain() {
    ...
    document.getElementById("text_aria").value=document.getElementById("text_aria").value+div.innerHTML
  }
  otpravkakategorii(e) {
    this.setState({
      [e.target.name]: e.target.value
  ...
  refresh_sel(cat, sub) {
    axios.get("http://5.23.48.203:1338/api/categories").then(response => {
        ...
        <button
          ...
          <form id="pozhaluista">
            ...
            <div className="flex_div_1">
              ...
              <button className="bittonfor_textusone_1" type="button" onClick={e => {
                  this.createintext();
                }}>span</button>
                <button className="bittonfor_textusone_2" type="button" onClick={e => {
                  this.createtext();
                }}>for all text</button>
                <input
                  id="a_1"
