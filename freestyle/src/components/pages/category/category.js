...
class Category extends Component {
  ...
  selectcat(e) {
    ...
    axios
      .post("http://5.23.48.203:1338/api/category", { name: id })
      .then(response => {
        ...
        button.addEventListener("click", e => {
          ...
          axios
            .post("http://5.23.48.203:1338/api/deletecategory", {
        ...
        button.addEventListener("click", e => {
          ...
          button_change.addEventListener("click", e => {
            ...
            axios
              .post("http://5.23.48.203:1338/api/updatecategory", {
        ...
        button.addEventListener("click", e => {
          ...
          axios
            .post("http://5.23.48.203:1338/api/addsubcategory", {
              cat_name: cat_name,
              name: name
            })
            .then(response => {
  ...
  create_ul(parent, data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      li.id = data[i].name;
      li.innerHTML = "Название:" + data[i].name;
      var button = this.create_button("Delete");
      button.addEventListener("click", e => {
        var cat_name = document.getElementById("cat_select").value;
        axios
          .post("http://5.23.48.203:1338/api/deletesubcategory", {
            cat_name: cat_name,
            name: li.id
          })
          .then(response => {
  ...
  addcat() {
    ...
    axios
      .post("http://5.23.48.203:1338/api/addcategory", jsonPost)
      .then(response => {
        this.refresh_sel();
      });
  }
